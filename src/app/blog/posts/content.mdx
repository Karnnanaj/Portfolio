...
Replace the `public/avatar.jpg` file with your own avatar image. It is used on the `/about` page as well as on the dynamically generated `open-graph` images.
...
`const home = {
    label: "Home",
    title: "Karnnan AJ's Portfolio",
    description: "Portfolio website showcasing my work as an Optoelectronics & Embedded Systems Engineer",
    headline: <>Design engineer and builder</>,
    subline: (
      <>
        I'm Karnnan, an MSc student in Photonics at <InlineCode>CUSAT</InlineCode>, specializing in <br /> quantum optics and embedded systems. Currently interning in optoelectronics.
      </>
    ),
};`,
    language: "tsx",
